const kindleNotesConfigKey = "kindle-notes";
const flashcardsHomePathConfigKey = "flashcardsHomePath";
...
export default {
    ...
    flashcardsHomePathConfigKey,
    headlessBrowserConfigKey,
    kindleEmailConfigKey,
    showLoggerConfigKey,
